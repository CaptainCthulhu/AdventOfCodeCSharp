...
namespace Day3
{
    class Program
    {
        ...
        static Dictionary<Direction, Point> Movement = new Dictionary<Direction, Point>()
        {
        ...
        static Vector Split(string s)
        {
            ...
            int intensity = Convert.ToInt32(s.Substring(1, s.Length - 1));
            return new Vector()
            {
                direction = direction,
                intensity = intensity
